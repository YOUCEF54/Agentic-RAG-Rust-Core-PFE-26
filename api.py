...
def query(payload: QueryRequest):
  ...
  refiner = QueryRefiner(lambda messages: openrouter_chat(messages, payload.chat_model))
  retriever = Retriever(lambda q, top_k: retrieve_for_agent(q, top_k), top_k=payload.top_k)
  generator = Generator(lambda messages: openrouter_chat(messages, payload.chat_model))
  evaluator = Evaluator(
    lambda messages: openrouter_chat(messages, payload.chat_model),
